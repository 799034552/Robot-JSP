...
//     // auto min_dis = min(min(wb.pos.first, 50 - wb.pos.first), min(wb.pos.second, 50 - wb.pos.second)); // 目标离墙距离
//     // auto target_dis = cal_distance(this->pos, wb.pos);
//     // if (min_dis < 3 && target_dis < 1 && cal_distance(this->linear_speed, {0,0}) > 4) {
//     //     forward_speed = 0;
//     // }
